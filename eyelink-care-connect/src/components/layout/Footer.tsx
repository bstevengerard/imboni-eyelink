        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center gap-3 mb-2">
             <img src={logo} alt="IMBONI EyeLink" className="h-16 sm:h-20 md:h-24 lg:h-[10rem] w-auto object-contain" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+250788000000" className="text-background/70 hover:text-secondary">
                  +250 788 000 000
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="h-5 w-5 text-secondary shrink-0" />
                <a href="mailto:info@imbonieyelink.rw" className="text-background/70 hover:text-secondary">
